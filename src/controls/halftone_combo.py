...
class HalftoneCombo(QWidget):
    ...
    def _create_combobox(self):
        ...
        combobox = QComboBox()
        algorithms = [
            "None", "Fixed threshold", "Sauvola threshold", "Phansalkar threshold", "Mezzotint", "Mezzotint Gauss", "Mezzotint beta", "Floyd-Steinberg", "False Floyd-Steinberg", "Jarvis", "Stucki", "Stucki small", "Stucki large", "Atkinson", "Burkes", "Sierra", "Sierra2", "Sierra2 4A", "Nakano"
        ]
