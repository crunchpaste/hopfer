...
class HalftoneCombo(QWidget):
    ...
    def _create_combobox(self):
        ...
        combobox = QComboBox()
        algorithms = [
            "None", "Threshold", "Sauvola threshold", "Phansalkar threshold", "Mezzo", "Floyd-Steinberg", "False Floyd-Steinberg", "Jarvis", "Stucki", "Stucki Small", "Stucki Large", "Atkinson", "Burkes", "Sierra", "Sierra2", "Sierra2 4A", "Nakano"
        ]
